...
export function createNoopRoomsController(): IAgentHostRoomsController {
	...
	return {
		...
		ensureCoordinator: unavailable,
		getCoordinator: async () => undefined,
		setCoordinatorModel: unavailable,
		getCoordinatorSnapshot: unavailable,
		...
		isCoordinatorSessionUri: () => false,
		isCoordinatorChat: () => false,
		isCoordinatorAdmittedTurn: () => false,
		isCoordinatorDirectTurnAvailable: () => false,
		getCoordinatorModelForChat: async () => undefined,
		setCoordinatorModelForChat: unavailable,
		getCoordinatorTurnSnapshot: async () => undefined,
		coordinatorSnapshot: unavailable,
		assign: unavailable,
		postCoordinationNote: unavailable,
		read: unavailable,
