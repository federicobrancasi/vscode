...
export const CustomViewAllowsSidePanelContext = new RawContextKey<boolean>('customViewAllowsSidePanel', false, localize('customViewAllowsSidePanel', "Whether the visible custom view keeps the side panel beside it instead of replacing it."));
