...
import { CopilotModelTeamConfigKey, CopilotModelTeamAppliedConfigKey, CopilotModelTeamLeadAppliedConfigKey, CopilotModelTeamRememberedConfigKey, CopilotModelTeamSupportConfigKey } from '../../../../../../platform/agentHost/common/copilotModelTeam.js';
...
suite('AgentHostGenericConfigChips', () => {
	...
	test('team configuration and runtime acknowledgements never become generic chips', () => {
		assert.deepStrictEqual([
			CopilotModelTeamConfigKey, CopilotModelTeamAppliedConfigKey,
			CopilotModelTeamLeadAppliedConfigKey, CopilotModelTeamSupportConfigKey,
			CopilotModelTeamRememberedConfigKey,
		].map(property => isClaimedByDedicatedPicker(property, { type: 'object', title: property })), [true, true, true, true, true]);
	});
