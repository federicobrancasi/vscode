...
export interface IModelPickerAdditionalActionGroup {
...
export interface IModelPickerDelegate {
	...
	/** Localized action groups shown before the models when the picker is available. */
	getAdditionalActionGroups?(): readonly IModelPickerAdditionalActionGroup[];
